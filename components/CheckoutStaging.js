...
export default function pay() {
    ...
    const paynow = () => {
        ...
        const data = { 
            ...
            clientId:"0a150b18-8f43-324c-9bca-bf59d94c172f", 
            publicKey:"MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCQpHWMrhGC8gekP0/OlkQz5Aj4cyRu5N2mQfCQvu9kB+EOAG5SFrJVHGY1muBJDAKADQ4g0xdiBFGiU41wPZuIBHCBYiktXTEZkR/ptx/eYK0FZTxke2Dc5mH5ZR07XbQhmD3yoD3xa7nzloapFAECPjHKuMdG7UMX7ovLQYnlKQIDAQAB", 
            merchantKey: "dl7lfcv.Lyx14L0VkvDw6eGQaviOTHdi-Og", 
            projectName: "culturexmm_staging", 
            merchantName: "Ivan", 
        }   
        ...
        const secretkey = "7e11913111596ebcbb679a3807eed484";
      ...
      <div class="container py-12 bg-[#fff] lg:px-[200px] px-[30px] mx-[0px] max-w-6xl mx-[0] lg:mx-[auto]">
            <div class="flex flex-col w-full px-0 mx-auto md:flex-row">
                <div class="flex flex-col md:w-full lg:w-3/6">
                    <h2 class="mb-4 font-bold md:text-xl text-heading border-b border-gray-300 pb-3">Staging Payment Form
                    </h2>
